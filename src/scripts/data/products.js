const mapaProductos = {
  1: {
    ...
    precio: 3200,
    imagen: "../assets/img/anillo-cubano.jpg",
    tipo: "Anillos",
  ...
  2: {
    ...
    precio: 2800,
    imagen: "../assets/img/anillo-apolo-personalizable.jpg",
    tipo: "Anillos",
  ...
  3: {
    ...
    nombre: "Anillo Ares",
    precio: 3500,
    imagen: "../assets/img/anillo-ares.jpg",
    tipo: "Anillos",
  ...
  4: {
    ...
    precio: 4000,
    imagen: "../assets/img/anillo-olympus.jpg",
    tipo: "Anillos",
  ...
  5: {
    ...
    nombre: "Anillo Panal",
    precio: 2700,
    imagen: "../assets/img/anillo-panal.jpg",
    tipo: "Anillos",
  ...
  6: {
    ...
    nombre: "Anillo Reloj",
    precio: 4500,
    imagen: "../assets/img/anillo-reloj.jpg",
    tipo: "Anillos",
  ...
  7: {
    ...
    precio: 2500,
    imagen: "../assets/img/aretes-bella.jpg",
    tipo: "Aretes",
  ...
  8: {
    ...
    precio: 2200,
    imagen: "../assets/img/aretes-flower.jpg",
    tipo: "Aretes",
  ...
  9: {
    ...
    precio: 2800,
    imagen: "../assets/img/aretes-gypsy.jpg",
    tipo: "Aretes",
  ...
  10: {
    ...
    precio: 4200,
    imagen: "../assets/img/aretes-joy.jpg",
    tipo: "Aretes",
  ...
  11: {
    ...
    precio: 3500,
    imagen: "../assets/img/aretes-olimpia.jpg",
    tipo: "Aretes",
  ...
  12: {
    ...
    precio: 2400,
    imagen: "../assets/img/aretes-trebol.jpg",
    tipo: "Aretes",
  ...
  13: {
    ...
    precio: 3200,
    imagen: "../assets/img/argollas-praga.jpg",
    tipo: "Argollas",
  ...
  14: {
    ...
    precio: 3800,
    imagen: "../assets/img/argollas-aura.jpg",
    tipo: "Argollas",
  ...
  15: {
    ...
    precio: 3500,
    imagen: "../assets/img/argollas-amara.jpg",
    tipo: "Argollas",
  ...
  16: {
    ...
    precio: 4200,
    imagen: "../assets/img/argollas-bria.jpg",
    tipo: "Argollas",
  ...
  17: {
    ...
    precio: 3300,
    imagen: "../assets/img/argollas-gaia.jpg",
    tipo: "Argollas",
  ...
  18: {
    ...
    precio: 4500,
    imagen: "../assets/img/argollas-tara.jpg",
    tipo: "Argollas",
  ...
  19: {
    ...
    precio: 5800,
    imagen: "../assets/img/brazalete-calado.jpg",
    tipo: "Brazaletes",
  ...
  20: {
    ...
    precio: 6500,
    imagen: "../assets/img/brazalete-centurion.jpg",
    tipo: "Brazaletes",
  ...
  21: {
    ...
    precio: 6200,
    imagen: "../assets/img/brazalete-leon.jpg",
    tipo: "Brazaletes",
  ...
  22: {
    ...
    precio: 6000,
    imagen: "../assets/img/brazalete-pantera.jpg",
    tipo: "Brazaletes",
  ...
  23: {
    ...
    precio: 5200,
    imagen: "../assets/img/brazalete-liso.jpg",
    tipo: "Brazaletes",
  ...
  24: {
    ...
    precio: 7000,
    imagen: "../assets/img/brazalete-magno.jpg",
    tipo: "Brazaletes",
  ...
  25: {
    ...
    precio: 5800,
    imagen: "../assets/img/pulso-rustico.jpg",
    tipo: "Pulsos",
  ...
  26: {
    ...
    precio: 6200,
    imagen: "../assets/img/pulso-franco.jpg",
    tipo: "Pulsos",
  ...
  27: {
    ...
    precio: 6800,
    imagen: "../assets/img/pulso-jade.jpg",
    tipo: "Pulsos",
  ...
  28: {
    ...
    precio: 6500,
    imagen: "../assets/img/pulso-serpiente.jpg",
    tipo: "Pulsos",
  ...
  29: {
    ...
    precio: 7200,
    imagen: "../assets/img/pulso-cuadrado.jpg",
    tipo: "Pulsos",
  ...
  30: {
    ...
    precio: 7500,
    imagen: "../assets/img/pulso-titan.jpg",
    tipo: "Pulsos",
  ...
  31: {
    ...
    precio: 6800,
    imagen: "../assets/img/pulsera-completo.jpg",
    tipo: "Pulseras",
  ...
  32: {
    ...
    precio: 7200,
    imagen: "../assets/img/pulsera-lateral.jpg",
    tipo: "Pulseras",
  ...
  33: {
    ...
    precio: 7900,
    imagen: "../assets/img/pulsera-intercalado.jpg",
    tipo: "Pulseras",
  ...
  34: {
    ...
    precio: 7500,
    imagen: "../assets/img/pulsera-entrelazado.jpg",
    tipo: "Pulseras",
  ...
  35: {
    ...
    precio: 8300,
    imagen: "../assets/img/pulsera-tres-lineas.jpg",
    tipo: "Pulseras",
  ...
  36: {
    ...
    precio: 7700,
    imagen: "../assets/img/pulsera-placa.jpg",
    tipo: "Pulseras",
  ...
  37: {
    ...
    precio: 9200,
    imagen: "../assets/img/dije-cruz-imperial.jpg",
    tipo: "Dijes",
  ...
  38: {
    ...
    nombre: "Dije Suprema",
    precio: 9800,
    imagen: "../assets/img/dije-suprema.jpg",
    tipo: "Dijes",
  ...
  39: {
    ...
    nombre: "Dije Goldier",
    precio: 10200,
    imagen: "../assets/img/dije-goldier.jpg",
    tipo: "Dijes",
  ...
  40: {
    ...
    nombre: "Dije Jade",
    precio: 11500,
    imagen: "../assets/img/dije-jade.jpg",
    tipo: "Dijes",
  ...
  41: {
    ...
    nombre: "Dije Medusa",
    precio: 8900,
    imagen: "../assets/img/dije-medusa.jpg",
    tipo: "Dijes",
  ...
  42: {
    ...
    precio: 10800,
    imagen: "../assets/img/dije-leon-magno.jpg",
    tipo: "Dijes",
  ...
  43: {
    ...
    nombre: "Cadena Ancla",
    precio: 12500,
    imagen: "../assets/img/cadena-ancla.jpg",
    tipo: "Cadenas",
  ...
  44: {
    ...
    precio: 9800,
    imagen: "../assets/img/cadena-egipcio.jpg",
    tipo: "Cadenas",
  ...
  45: {
    ...
    precio: 11200,
    imagen: "../assets/img/cadena-grabada.jpg",
    tipo: "Cadenas",
  ...
  46: {
    ...
    nombre: "Cadena Lazo",
    precio: 10500,
    imagen: "../assets/img/cadena-lazo.jpg",
    tipo: "Cadenas",
  ...
  47: {
    ...
    precio: 13500,
    imagen: "../assets/img/cadena-rustic.jpg",
    tipo: "Cadenas",
  ...
  48: {
    ...
    precio: 14200,
    imagen: "../assets/img/cadena-serpiente.jpg",
    tipo: "Cadenas",
  ...
  49: {
    ...
    nombre: "Anillo Lucia",
    precio: 4500,
    imagen: "../assets/img/anillo-lucia.jpg",
    tipo: "Anillos",
    material: "Plata 925",
  ...
  50: {
    ...
    precio: 6800,
    imagen: "../assets/img/aretes-velvet.jpg",
    tipo: "Aretes",
    material: "Oro 18k",
  ...
  51: {
    ...
    nombre: "Dije Lumini",
    precio: 9200,
    imagen: "../assets/img/dije-lumini.jpg",
    tipo: "Dijes",
    material: "Oro 18k",
  ...
  52: {
    ...
    precio: 15500,
    imagen: "../assets/img/pulsera-completa-placa.jpg",
    tipo: "Pulseras",
    material: "Oro 18k",
  ...
  53: {
    ...
    precio: 11500,
    imagen: "../assets/img/dije-corazon-caballo.jpg",
    tipo: "Dijes",
    material: "Oro 18k",
  ...
  54: {
    ...
    nombre: "Dije Pegaso",
    precio: 12800,
    imagen: "../assets/img/dije-pegaso.jpg",
    tipo: "Dijes",
    material: "Oro 18k",
  ...
  55: {
    ...
    precio: 9500,
    imagen: "../assets/img/dije-cruz-brillante.jpg",
    tipo: "Dijes",
    material: "Oro 18k",
